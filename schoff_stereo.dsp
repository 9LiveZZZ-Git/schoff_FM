...
masterFX(l, r) = (l * master_gain : ma.tanh, r * master_gain : ma.tanh);

// =============================================================================
// OUTPUT - Voice output, effects in effect block for polyphony
// =============================================================================

process = voice_L, voice_R;

// Effect chain applied after all voices are summed (polyphonic mode)
effect = exciterFX : chorusFX : delayFX : reverbFX : masterFX;
